...
#define VAR_MTCHIMNEY_SKIDDO                             0x408B
...
#define VAR_JAGGED_PASS_B2B                              0x40BB
...
#define VAR_ALWAYS_CATCH                                 0x40DB
#define VAR_EV_GAIN                                      0x40DC
