...
const u8 gText_PkmnMaxRestored[] = _("{STR_VAR_1} was fully restored.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_BPShop_AssaultVest[] = _("ASSAULT VEST{CLEAR_TO 0x5E}3BP");
const u8 gText_BPShop_Eviolite[] = _("EVIOLITE{CLEAR_TO 0x5E}3BP");
...
const u8 gText_BPShop_GoldBottleCap[] = _("GOLD BOTTLE CAP{CLEAR_TO 0x5E}4BP");
...
const u8 gText_BPShop_AssaultVestDesc[] = _("Boosts Sp. Defense.");
const u8 gText_BPShop_EvioliteDesc[] = _("Boosts Defense.");
...
const u8 gText_BPShop_GoldBottleCapDesc[] = _("An item that can be used to\nset a Pokémon's IV to zero.");

const u8 gText_Fish_Magikarp[] = _("MAGIKARP{CLEAR_TO 0x5E}¥500");
const u8 gText_Fish_Goldeen[] = _("GOLDEEN{CLEAR_TO 0x5E}¥500");
const u8 gText_Fish_Chinchou[] = _("CHINCHOU{CLEAR_TO 0x5E}¥5000");
const u8 gText_Fish_Qwilfish[] = _("QWILFISH{CLEAR_TO 0x5E}¥10000");
const u8 gText_Fish_Remoraid[] = _("REMORAID{CLEAR_TO 0x5E}¥500");
const u8 gText_Fish_Carvanha[] = _("CARVANHA{CLEAR_TO 0x5E}¥5000");
const u8 gText_Fish_Barboach[] = _("BARBOACH{CLEAR_TO 0x5E}¥1000");
const u8 gText_Fish_Feebas[] = _("FEEBAS{CLEAR_TO 0x5E}¥1000");
const u8 gText_Fish_Finneon[] = _("FINNEON{CLEAR_TO 0x5E}¥1000");
const u8 gText_Fish_Basculin[] = _("BASCULIN{CLEAR_TO 0x5E}¥10000");
...
const u8 gText_GameCorner_PsychicTM[] = _("TM29 Psychic");
const u8 gText_GameCorner_LeechLifeTM[] = _("TM32 Leech Life");
const u8 gText_GameCorner_ThunderboltTM[] = _("TM24 Thunderbolt");
const u8 gText_GameCorner_IceBeamTM[] = _("TM13 Ice Beam");
const u8 gText_GameCorner_ShadowBallTM[] = _("TM30 Shadow Ball");
const u8 gText_GameCorner_IceSpinnerTM[] = _("TM70 Ice Spinner");
const u8 gText_GameCorner_EarthPowerTM[] = _("TM41 Earth Power");
const u8 gText_GameCorner_FlashCannonTM[] = _("TM99 Flash Cannon");
const u8 gText_GameCorner_DarkPulseTM[] = _("TM100 Dark Pulse");
...
const u8 gText_LittleEmeraldVersion[] = _("v1.5");
const u8 gText_VersionDifficulty_Hard[] = _("HARD MODE v1.5");
const u8 gText_VersionDifficulty_Normal[] = _("NORMAL MODE v1.5");
const u8 gText_VersionDifficulty_Hard_Sandbox[] = _("SANDBOX / HARD MODE v1.5");
const u8 gText_VersionDifficulty_Normal_Sandbox[] = _("SANDBOX / NORMAL MODE v1.5");
...
const u8 gText_Stellar[]   = _("STELLAR");
...
const u8 gText_HyperTrain[] = _("HYPER TRAIN");
const u8 gText_UnTrain[] = _("UNTRAIN");

const u8 gText_A[] = _("A");
const u8 gText_B[] = _("B");
const u8 gText_C[] = _("C");
const u8 gText_D[] = _("D");
const u8 gText_E[] = _("E");
const u8 gText_F[] = _("F");
const u8 gText_G[] = _("G");
const u8 gText_H[] = _("H");
const u8 gText_I[] = _("I");
const u8 gText_J[] = _("J");
const u8 gText_K[] = _("K");
const u8 gText_L[] = _("L");
const u8 gText_M[] = _("M");
const u8 gText_N[] = _("N");
const u8 gText_O[] = _("O");
const u8 gText_P[] = _("P");
const u8 gText_Q[] = _("Q");
const u8 gText_R[] = _("R");
const u8 gText_S[] = _("S");
const u8 gText_T[] = _("T");
const u8 gText_U[] = _("U");
const u8 gText_V[] = _("V");
const u8 gText_W[] = _("W");
const u8 gText_X[] = _("X");
const u8 gText_Y[] = _("Y");
const u8 gText_Z[] = _("Z");
const u8 gText_Other[] = _("?");

const u8 gText_EvGainOn[] = _("EV Gain enabled.");
const u8 gText_EvGainOff[] = _("EV Gain disabled.");
const u8 gText_AlwaysCatchOn[] = _("100% Catch Rate activated.");
const u8 gText_AlwaysCatchOff[] = _("100% Catch Rate deactivated.");
const u8 gText_NoTrainersOn[] =  _("Trainer battles disabled.");
const u8 gText_NoTrainersOff[] = _("Trainer battles enabled.");
const u8 gText_WalkThroughWallsOn[] =  _("Collision disabled.");
const u8 gText_WalkThroughWallsOff[] = _("Collision enabled.");

const u8 gText_GameCorner_CloseCombat[]       = _("Close Combat");
const u8 gText_GameCorner_Crunch[]            = _("Crunch");
const u8 gText_GameCorner_FlareBlitz[]        = _("Flare Blitz");
const u8 gText_GameCorner_HydroPump[]         = _("Hydro Pump");
const u8 gText_GameCorner_AquaTail[]          = _("Aqua Tail");
const u8 gText_GameCorner_DragonRush[]        = _("Dragon Rish");
const u8 gText_GameCorner_FocusBlast[]        = _("Focus Blast");
const u8 gText_GameCorner_HeavySlam[]         = _("Heavy Slam");
const u8 gText_GameCorner_LeafStorm[]         = _("Leaf Storm");
const u8 gText_GameCorner_Thrash[]            = _("Thrash");
const u8 gText_GameCorner_Outrage[]           = _("Outrage");
const u8 gText_GameCorner_Boomburst[]         = _("Boomburst");
const u8 gText_GameCorner_Hurricane[]         = _("Hurricane");
const u8 gText_GameCorner_StoneEdge[]         = _("Stone Edge");
const u8 gText_GameCorner_HeatWave[]          = _("Heat Wave");
const u8 gText_GameCorner_PowerWhip[]         = _("Power Whip");
const u8 gText_GameCorner_RagingFury[]        = _("Raging Fury");
const u8 gText_GameCorner_PsychoBoost[]       = _("Psycho Boost");
const u8 gText_GameCorner_EnergyBall[]        = _("Energy Ball");
const u8 gText_GameCorner_WildCharge[]        = _("Wild Charge");
const u8 gText_GameCorner_HighHorsepower[]    = _("High Horsepower");
const u8 gText_GameCorner_ThroatChop[]        = _("Throat Chop");
...
const u8 gText_GameCorner_Megahorn[]          = _("Megahorn");
const u8 gText_GameCorner_DragonPulse[]       = _("Dragon Pulse");
const u8 gText_GameCorner_HeadSmash[]         = _("Head Smash");
const u8 gText_GameCorner_Superpower[]        = _("Superpower");
const u8 gText_GameCorner_SolarBlade[]        = _("Solar Blade");
const u8 gText_GameCorner_SkyAttack[]         = _("Sky Attack");
const u8 gText_GameCorner_MuddyWater[]        = _("Muddy Water");
const u8 gText_GameCorner_HammerArm[]         = _("Hammer Arm");
const u8 gText_GameCorner_MeteorBeam[]        = _("Meteor Beam");
const u8 gText_GameCorner_ScorchingSands[]    = _("Scorching Sands");
