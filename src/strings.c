...
const u8 gText_VersionDifficulty_Hard_Sandbox[] = _("SANDBOX / HARD MODE v1.3");
const u8 gText_VersionDifficulty_Normal_Sandbox[] = _("SANDBOX / NORMAL MODE v1.3");
...
const u8 gText_GameCorner_Overheat[]    = _("Overheat");