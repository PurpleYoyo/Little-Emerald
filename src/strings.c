...
const u8 gText_LittleEmeraldVersion[] = _("v1.4");
const u8 gText_VersionDifficulty_Hard[] = _("HARD MODE v1.4");
const u8 gText_VersionDifficulty_Normal[] = _("NORMAL MODE v1.4");
const u8 gText_VersionDifficulty_Hard_Sandbox[] = _("SANDBOX / HARD MODE v1.4");
const u8 gText_VersionDifficulty_Normal_Sandbox[] = _("SANDBOX / NORMAL MODE v1.4");
